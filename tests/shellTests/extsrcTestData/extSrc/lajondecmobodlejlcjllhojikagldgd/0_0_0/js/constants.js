...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('zoom-chrome-install-button')) {
		...
		$('zoom-chrome-thanks-button').style.display = 'block';
	}
}
...
var linkchangelog = "https://www.stefanvd.net/project/zoom/browser/google-chrome/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/zoom/browser/google-chrome/guide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/zoom/browser/google-chrome/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/zoom/browser/google-chrome/uninstall.htm";
